...
def get_posts(db: Session = Depends(get_db),
    ...
    ##By default below will user inner join 
...
def create_posts(post: schemas.PostCreate, db : Session = Depends(get_db),
    ...
    new_post = models.Post(owner_id=current_user.id,**post.dict())  # this is much cleaner than above line and also handles all fields
